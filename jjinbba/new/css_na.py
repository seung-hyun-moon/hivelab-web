...
[class^=panel_group]+.detail_panel,.detail_panel+{
    left: 406px
}

[class^=panel_group].is-folded~{
    left: 0
}
...
.btn_report-false[disabled] {
    cursor: default
}

.td_link--viewmore,.td_link--housenumber {
    display: inline-block;
    vertical-align: middle
}
...
.btn_info_more .icon_arrow_right {
    font-size: 9px;
    vertical-align: -1px;
    -webkit-transform: scale(0.9);
    -ms-transform: scale(0.9);
...
.btns_output .btns_output_function {
    padding-left: 8px;
    padding-right: 7px;
    line-height: 1;
    border-radius: 1px;
...
.btns_output .btns_output_function:not(:last-child) {
    float: left
}

.btns_output .btns_output_function>button:not(:first-child):before {
    content: "";
    width: 1px;
    height: 10px;
    display: inline-block;
...
.btns_output .btns_output_favorite {
    line-height: 1;
    background-color: #fff
}

.btns_output .btns_output_favorite:not(:first-child) {
    float: right;
    margin-left: 5px
}

.btns_output .btns_output_favorite .btn_favorite_info {
    line-height: 1;
    vertical-align: top;
    border-radius: 1px
}

.btns_output .btns_output_favorite .btn_favorite_info:not([aria-pressed=true]) {
    padding: 3px;
    border: 1px solid #ccc
}

.btns_output .btns_output_favorite .btn_favorite_info[aria-pressed=true] {
    padding: 4px;
    background: linear-gradient(136deg, #25bb3c, #29b73f 48%, #26a93a)
}

.btns_output .btns_output_favorite .btn_favorite_info[aria-pressed=true] .icon {
    color: #fff
}

.btns_output .btns_output_favorite .btn_favorite_info[aria-pressed=true] .icon:before {
    content: "\E060"
}

.btns_output .btns_output_favorite [class*=popup_wrap] {
    top: 23px;
    left: auto;
    right: 0
}

.btns_output .btns_output_favorite .icon {
    vertical-align: top;
    font-size: 15px;
    color: rgba(0,0,0,.25)
}
