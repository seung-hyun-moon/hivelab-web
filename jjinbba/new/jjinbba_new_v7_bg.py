...
# pyinstaller --onefile --icon="C:\Hivelab\hivelab-web\frontend\static\icon\favicon.ico" --noconsole "jjinbba/new/jjinbba_new_v7_bg.py"
...
class MyApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('New 찐빠 v7! - 백구')
