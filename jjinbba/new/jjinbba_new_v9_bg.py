...
# pyinstaller --onefile --icon="C:\Hivelab\hivelab-web\frontend\static\icon\favicon.ico" --noconsole "jjinbba/new/jjinbba_new_v9_bg.py"
# pyinstaller --onefile --icon="C:\Users\coolu\Desktop\Hive\hivelab-web\frontend\static\icon\favicon.ico" --noconsole "jjinbba/new/jjinbba_new_v9_bg.py"
...
class MyApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('New 찐빠 v9! (24.09.29)')
